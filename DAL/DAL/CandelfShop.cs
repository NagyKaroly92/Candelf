// Licence file C:\Users\KA-DELL\Documents\ReversePOCO.txt not found.
...
namespace DAL
{
    ...
    public class MyDbContext : DbContext, IMyDbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=192.168.2.11;Initial Catalog=CandelfShop;Integrated Security=False;User Id=teszt;Password=Teszt1234*;TrustServerCertificate=true");
            }
        }
    ...
    public class Alapanyag
    {
        ...
        public int IllatId { get; set; } // IllatId
        ...
        /// <summary>
        /// Parent Illat pointed by [Alapanyag].([IllatId]) (FK_Table.Alapanyag_Table.Illat)
        /// </summary>
        public Illat Illat { get; set; } // FK_Table.Alapanyag_Table.Illat

        /// <summary>
        /// Parent MennyisegiEgyseg pointed by [Alapanyag].([MennyisegiEgysegId]) (FK_Table.Alapanyag_Table.MennyisegiEgyseg)
        /// </summary>
        public MennyisegiEgyseg MennyisegiEgyseg { get; set; } // FK_Table.Alapanyag_Table.MennyisegiEgyseg
    ...
    public class Illat
    {
        ...
        /// <summary>
        /// Child Alapanyags where [Alapanyag].[IllatId] point to this entity (FK_Table.Alapanyag_Table.Illat)
        /// </summary>
        public ICollection<Alapanyag> Alapanyags { get; set; } // Alapanyag.FK_Table.Alapanyag_Table.Illat
    ...
    public class MennyisegiEgyseg
    {
        ...
        /// <summary>
        /// Child Alapanyags where [Alapanyag].[MennyisegiEgysegId] point to this entity (FK_Table.Alapanyag_Table.MennyisegiEgyseg)
        /// </summary>
    ...
    // Alapanyag
    public class AlapanyagConfiguration : IEntityTypeConfiguration<Alapanyag>
    {
        public void Configure(EntityTypeBuilder<Alapanyag> builder)
        {
            builder.ToTable("Alapanyag", "dbo");
            builder.HasKey(x => x.Id).HasName("PK_Table.Alapanyag").IsClustered();
            ...
            builder.Property(x => x.IllatId).HasColumnName(@"IllatId").HasColumnType("int").IsRequired();
            builder.Property(x => x.MennyisegiEgysegId).HasColumnName(@"MennyisegiEgysegId").HasColumnType("int").IsRequired();
            builder.Property(x => x.Torolt).HasColumnName(@"Torolt").HasColumnType("bit").IsRequired();

            // Foreign keys
            builder.HasOne(a => a.Illat).WithMany(b => b.Alapanyags).HasForeignKey(c => c.IllatId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_Table.Alapanyag_Table.Illat");
            builder.HasOne(a => a.MennyisegiEgyseg).WithMany(b => b.Alapanyags).HasForeignKey(c => c.MennyisegiEgysegId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_Table.Alapanyag_Table.MennyisegiEgyseg");
        }
    }
    ...
    {
        public void Configure(EntityTypeBuilder<Illat> builder)
        {
            builder.ToTable("Illat", "dbo");
            builder.HasKey(x => x.Id).HasName("PK_Table.Illat").IsClustered();
    ...
    // MennyisegiEgyseg
    public class MennyisegiEgysegConfiguration : IEntityTypeConfiguration<MennyisegiEgyseg>
    {
        public void Configure(EntityTypeBuilder<MennyisegiEgyseg> builder)
        {
            builder.ToTable("MennyisegiEgyseg", "dbo");
            builder.HasKey(x => x.Id).HasName("PK_Table.MennyisegiEgyseg").IsClustered();
    ...
    // Meret
    public class MeretConfiguration : IEntityTypeConfiguration<Meret>
    {
        public void Configure(EntityTypeBuilder<Meret> builder)
        {
            builder.ToTable("Meret", "dbo");
            builder.HasKey(x => x.Id).HasName("PK_Table.Meret").IsClustered();
